...
## Archivos del portafolio de datos

En la raíz también quedan dos archivos del portafolio de análisis de datos que vivía
antes en este repo:

- `Sales Performance Dashboard.xlsm` — dashboard interactivo de ventas en Excel
- `dataset sneakers.xlsx` — el dataset de Kaggle que lo alimenta

No tienen relación con la app ni afectan al build; Vercel los ignora.
